use btc::bech32::{Bech32, MAIN_NET_BTC, EncodingType, Bech32Error, Bech32Decoded, Payload};
...
fn test_bech32_should_return_wrongwitnessversionerror_payload_witnessversion_wrong_decode_fn() {
  let bech32_address_1 = String::from("bc1qqvcd2n7sm4pq5mjl35mzfa0nfqk2udg0082lqafm7klwl8pdjxhncyrfguw"); // when witness version is zero, program must be either 20 or 32 bits
